                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-gray-300">
                        ...
                        <td className="text-right p-1 border-r border-black text-[10px]">.73</td>
                        <td className="text-right p-1 border-r border-black text-[10px] font-bold">.85</td>
                        <td className="text-right p-1 text-[10px] font-bold">.95</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
